...
public class ErrorPageController implements ErrorController {
	...
	public String error(Model model, HttpServletRequest request) {
		// RequestAttributes rA = new ServletRequestAttributes(request); --nem jó kód
	...
	/*@Autowired
	public String is404(Model model, HttpServletRequest request) {
		ServletWebRequest rA = new ServletWebRequest(request);
		Map<String, Object> error = this.errorAttributes.getErrorAttributes(rA, true);
		if (error.get("message") == "404") {
